...
function Draggable(el, options){
    ...
    var setScrollable = function(){
        ...
        scrollable.each(function(){
            ...
            if(obj.isBody){
                obj.top = 0;
                obj.left = 0;
                obj.bottom = $(window).height();
                obj.right = $(window).width();
                obj.innerHeight = $(window).height();
                obj.innerWidth = $(window).width();
            }
    ...
    this.getPosition = function(el){
        ...
        return {
            y : draggableBox.position().top + parent.scrollTop(),
            x : draggableBox.position().left + parent.scrollLeft(),
        }
    };
...
function Resizable(el, options){
    ...
    this.getSize = function(){
        ...
        var values = {
            width : self.el.width(),
            height : self.el.height(),
            left : self.el.position().left + parent.scrollLeft(),
            top : self.el.position().top + parent.scrollTop(),
